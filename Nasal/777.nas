...
var save_state = func {
    if (getprop("aircraft/settings/fuel_persistent")) {
		...
		setprop("aircraft/settings/hydraulics/brake-accumulator/press-raw", getprop("systems/hydraulics/system[2]/brake-accumulator/press-raw"));
		setprop("aircraft/settings/hydraulics/brakesystem/left-level-gal", getprop("systems/hydraulics/brakesystem/left-level-gal"));	
		setprop("aircraft/settings/hydraulics/brakesystem/left-level-norm", getprop("systems/hydraulics/brakesystem/left-level-norm"));	
		setprop("aircraft/settings/hydraulics/brakesystem/right-level-gal", getprop("systems/hydraulics/brakesystem/right-level-gal"));	
		setprop("aircraft/settings/hydraulics/brakesystem/right-level-norm", getprop("systems/hydraulics/brakesystem/right-level-norm"));	
		setprop("aircraft/settings/hydraulics/brakesystem/brakesource", getprop("systems/hydraulics/brakesystem/brakesource"));	
		setprop("aircraft/settings/hydraulics/reservoir[0]/level-gal", getprop("consumables/hydraulics/reservoir[0]/level-gal"));
		setprop("aircraft/settings/hydraulics/reservoir[1]/level-gal", getprop("consumables/hydraulics/reservoir[1]/level-gal"));
		setprop("aircraft/settings/hydraulics/reservoir[2]/level-gal", getprop("consumables/hydraulics/reservoir[2]/level-gal"));
    };
    ...
    if (getprop("aircraft/settings/ground_services_persistent")) {
		...
		setprop("aircraft/settings/services/cones/coneLW", getprop("services/cones/coneLW-enable") or 0);
		setprop("aircraft/settings/services/cones/coneRW", getprop("services/cones/coneRW-enable") or 0);
		setprop("aircraft/settings/services/cones/coneTailL", getprop("services/cones/coneTailL-enable") or 0);
		setprop("aircraft/settings/services/cones/coneTailR", getprop("services/cones/coneTailR-enable") or 0);
        #Air Start Unit
...
var load_state = func {
    ...
    if (getprop("aircraft/settings/fuel_persistent")) {
        ...
        if ((getprop("aircraft/settings/fuel/tank_level-lbs") != nil) and (getprop("aircraft/settings/fuel/tank1_level-lbs") != nil) and (getprop("aircraft/settings/fuel/tank2_level-lbs") != nil)) {
			...
			if (getprop("aircraft/settings/hydraulics/brake-accumulator/press-raw") != nil) {
				setprop("systems/hydraulics/system[2]/brake-accumulator/press-raw", getprop("aircraft/settings/hydraulics/brake-accumulator/press-raw"));
				setprop("systems/hydraulics/brakesystem/left-level-gal", getprop("aircraft/settings/hydraulics/brakesystem/left-level-gal"));	
				setprop("systems/hydraulics/brakesystem/left-level-norm", getprop("aircraft/settings/hydraulics/brakesystem/left-level-norm"));	
				setprop("systems/hydraulics/brakesystem/right-level-gal", getprop("aircraft/settings/hydraulics/brakesystem/right-level-gal"));	
				setprop("systems/hydraulics/brakesystem/right-level-norm", getprop("aircraft/settings/hydraulics/brakesystem/right-level-norm"));	
				setprop("systems/hydraulics/brakesystem/brakesource", getprop("aircraft/settings/hydraulics/brakesystem/brakesource"));	
				setprop("consumables/hydraulics/reservoir[0]/level-gal", getprop("aircraft/settings/hydraulics/reservoir[0]/level-gal"));
				setprop("consumables/hydraulics/reservoir[1]/level-gal", getprop("aircraft/settings/hydraulics/reservoir[1]/level-gal"));
				setprop("consumables/hydraulics/reservoir[2]/level-gal", getprop("aircraft/settings/hydraulics/reservoir[2]/level-gal"));
				print("Hydraulics state ..... Loaded");
			}
		...
		setprop("systems/hydraulics/system[2]/brake-accumulator/press-raw", 320.0);
		setprop("consumables/hydraulics/reservoir[0]/level-gal", 7.39);
		setprop("consumables/hydraulics/reservoir[1]/level-gal", 11.01);
		setprop("consumables/hydraulics/reservoir[2]/level-gal", 7.39);
		setprop("systems/hydraulics/brakesystem/left-level-gal", 0);
		setprop("systems/hydraulics/brakesystem/right-level-gal", 0);
		setprop("systems/hydraulics/brakesystem/left-level-norm", 0);
		setprop("systems/hydraulics/brakesystem/right-level-norm", 0);
		setprop("systems/hydraulics/brakesystem/brakesource", 2);
    };
    ...
    if (getprop("aircraft/settings/ground_services_persistent")) {
        if (getprop("aircraft/settings/services/stairs/stairs1_enable") != nil) {
            ...
            setprop("services/cones/coneLW-enable", getprop("aircraft/settings/services/cones/coneLW") or 0);
            setprop("services/cones/coneRW-enable", getprop("aircraft/settings/services/cones/coneRW") or 0);
            setprop("services/cones/coneTailL-enable", getprop("aircraft/settings/services/cones/coneTailL") or 0);
            setprop("services/cones/coneTailR-enable", getprop("aircraft/settings/services/cones/coneTailR") or 0);
            #Air Start Unit
        ...
        else
        {
			...
			setprop("controls/gear/brake-parking-set", 1);
        };
	
		setprop("aircraft/settings/autoconnect/launch", 1);
	
    } else {
        #Disable Autoconnect persistence - default profile
        setprop("aircraft/settings/autoconnect/GPU1", 1);
        setprop("aircraft/settings/autoconnect/GPU2", 0);
        setprop("aircraft/settings/autoconnect/Chocks", 1);
        setprop("aircraft/settings/autoconnect/Cones", 1);
        setprop("aircraft/settings/autoconnect/Jetway1", 1);
        setprop("aircraft/settings/autoconnect/Jetway2", 0);
        setprop("aircraft/settings/autoconnect/Stairs1", 0);
        setprop("aircraft/settings/autoconnect/Stairs2", 0);
        setprop("aircraft/settings/autoconnect/Stairs3", 0);
        setprop("aircraft/settings/autoconnect/Stairs4", 0);
        setprop("aircraft/settings/autoconnect/Catering1", 0);
        setprop("aircraft/settings/autoconnect/Catering2", 1);
        setprop("aircraft/settings/autoconnect/Catering3", 1);
        setprop("aircraft/settings/autoconnect/Catering4", 1);
        setprop("aircraft/settings/autoconnect/FuelTruck", 1);
        setprop("aircraft/settings/autoconnect/FuelTruckPipe", 1);
        setprop("aircraft/settings/autoconnect/Bus1", 0);
        setprop("aircraft/settings/autoconnect/Bus2", 0);
        setprop("aircraft/settings/autoconnect/Baggage1", 1);
        setprop("aircraft/settings/autoconnect/Baggage2", 1);
		setprop("aircraft/settings/autoconnect/launch", 0);
    };
