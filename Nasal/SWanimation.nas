...
var LENGFlt = aircraft.door.new("controls/switches/LENGFaultTimer", duration * 3);
var RENGFlt = aircraft.door.new("controls/switches/RENGFaultTimer", duration * 3);
var C1ELECFlt = aircraft.door.new("controls/switches/C1ELECFaultTimer", duration * 3);
var C2ELECFlt = aircraft.door.new("controls/switches/C2ELECFaultTimer", duration * 3);
var LACMPFlt = aircraft.door.new("controls/switches/LACMPFaultTimer", duration * 3);
var RACMPFlt = aircraft.door.new("controls/switches/RACMPFaultTimer", duration * 3);
var C1ADPFlt = aircraft.door.new("controls/switches/C1ADPFaultTimer", duration * 3);
var C2ADPFlt = aircraft.door.new("controls/switches/C2ADPFaultTimer", duration * 3);
...
setlistener("controls/fuel/jettison-arm-switch", func {
        if(getprop("controls/fuel/jettison-arm-switch")) JTSNARMST.open();
        else JTSNARMST.close();
});
setlistener("controls/fuel/jettison-FTR-manual", func {
        if(getprop("controls/fuel/jettison-FTR-manual")) JTSNMANST.open();
        else JTSNMANST.close();
});
...
setlistener("controls/hydraulics/system/LENG_switch", func {
        if(getprop("controls/hydraulics/system/LENG_switch")) {
			LENGST.open();
			LENGFlt.open();
		} else {
			LENGST.close();
...
setlistener("controls/hydraulics/system/LACMP-switch", func {
        if(getprop("controls/hydraulics/system/LACMP-switch") > 0) LACMPFlt.open();
        else LACMPFlt.close();
});
setlistener("controls/hydraulics/system[2]/RENG_switch", func {
       if(getprop("controls/hydraulics/system[2]/RENG_switch")) {
			RENGST.open();
			RENGFlt.open();
		} else {
			RENGST.close();
...
setlistener("controls/hydraulics/system[2]/RACMP-switch", func {
        if(getprop("controls/hydraulics/system[2]/RACMP-switch") > 0) RACMPFlt.open();
        else RACMPFlt.close();
});
setlistener("controls/hydraulics/system[1]/C1ELEC-switch", func {
        if(getprop("controls/hydraulics/system[1]/C1ELEC-switch")) {
			C1ELECST.open();
			C1ELECFlt.open();
		} else {
			C1ELECST.close();
...
setlistener("controls/hydraulics/system[1]/C1ADP-switch", func {
        if(getprop("controls/hydraulics/system[1]/C1ADP-switch") > 0) C1ADPFlt.open();
        else C1ADPFlt.close();
});
setlistener("controls/hydraulics/system[1]/C2ELEC-switch", func {
        if(getprop("controls/hydraulics/system[1]/C2ELEC-switch")) {
			C2ELECST.open();
			C2ELECFlt.open();
		} else {
			C2ELECST.close();
...
setlistener("controls/hydraulics/system[1]/C2ADP-switch", func {
        if(getprop("controls/hydraulics/system[1]/C2ADP-switch") > 0) C2ADPFlt.open();
        else C2ADPFlt.close();
});
