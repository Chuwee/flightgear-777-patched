...
var BrakeSystem =
{
    ...
    update : func()
    {
        ...
        if (dt<1.0)
        {
            ...
            if (getprop("controls/gear/brake-parking-set"))
                var BrakeLevel=1.0;
            else
    ...
    smoke : func()
    {
        if ((me.SmokeActive)and(getprop("gear/brake-thermal-energy")>1))
        {
            ...
            if (ThermalEnergy < 1.5)
                ...
                # Pseudopilot demo patch: never spawn fire-services
                # vehicles on brake overheat. They are distracting in
                # the demo and do not add useful signal.
                setprop("sim/animation/fire-services",0);
            }
