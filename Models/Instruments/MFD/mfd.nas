...
var mfdListener = nil;
    ...
    var MfDPanel = {
        ...
        new : func(name,canvas_group,svgFile,updateFunc)
        {
            ...
            {
					return "MD11_Octal450/MD11DU.ttf";
            };
    ...
    var MFD = {
        ...
        new : func(placement) 
        {
			...
			m.hydDisplay = HydPanel.new(m.group);
        ...
        togglePopup : func()
        {
            ...
            if (me.popupId < 0) {
                me.popupWnd = canvas.Window.new([500, 500],"MFD");
...
var mfdReload= func() {
	...
	io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777/Models/Instruments/MFD/hyd.nas","b777");
    mfdCreate();
}