...
load_nasal(fgdatadir~"/Nasal/math.nas","b777");
load_nasal(fgdatadir~"/Nasal/string.nas","string");
...
nsm.describe("a fuel panel",func() {
    ...
    nsm.it("can init pumps",func() {
        ...
        nsm.expect(fuel_panel.registry.registry["controls/fuel/tank[0]/m-boost-pump[0]"]).toBeDefined();
    });
...
nsm.describe("a valve",func() {
    nsm.it("can be closed",func(){
        ...
        var valve = b777.Valve.new(symbClosed, symbOpened, symbBlocked);
        valve.update(0);
